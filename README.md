...
| プロジェクト名 | 概要 | 使用技術 | リンク |
|---|---|---|---|
| **The Marble** | オンラインマーブルレースゲーム。 | Unity / C# / Photon | [GitHub リポジトリ](リンク) / [デモ](リンク) |
| **AI人狼** | 人間がAIのフリをしなければならないゲーム。 | Unity / C# / Photon/ Gemini API/ Google App Scripts | [GitHub リポジトリ](リンク) / [デモ](リンク) |
| **探索ホラーゲーム** | カメラを置いて敵から身を逃げつつ脱出するゲーム | Unity / C# | [GitHub リポジトリ](リンク) / [デモ](リンク) |
| **靴を使ったゴルフゲーム** | 片方の靴を勢いよく飛ばしてもう片方の靴に揃えるゲーム | Unity / C# | [GitHub リポジトリ](リンク) / [デモ](リンク) |
